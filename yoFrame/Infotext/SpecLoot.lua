...
function Stat:Enable()
	...
	self.Text1:SetHeight( n.infoTexts.RightInfoPanel:GetHeight())
	...
	self.Icon1:SetHeight( n.infoTexts.RightInfoPanel:GetHeight())
	self.Icon1:SetWidth( n.infoTexts.RightInfoPanel:GetHeight())

	self.Text2:SetHeight( n.infoTexts.RightInfoPanel:GetHeight())
	...
	self.Icon2:SetHeight( n.infoTexts.RightInfoPanel:GetHeight())
	self.Icon2:SetWidth( n.infoTexts.RightInfoPanel:GetHeight())
