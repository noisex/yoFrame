...
C["font"] = {
	["filger_font"] = fontpx,
	["filger_font_size"] = 10,
	["filger_font_style"] = "OUTLINE", --MONOCHROME",
	["filger_font_shadow"] = false,

	["cooldown_timers_font"] = fontpx,
	["cooldown_timers_font_size"] = 10,
...
C["filger"] = {
	...
	["buffs_size"] 		= 25,						-- Buffs size
	["cooldown_size"] 	= 25,						-- Cooldowns size
	["pvp_size"] 		= 25,						-- PvP debuffs size
	["barWidth"]		= 203,
	["barHeight"]		= 10,
}
...
C["filger_spells"] = {
	["DEATHKNIGHT"] = {
		...
		},
		{
			...
			Alpha = 1,
			IconSize = C.filger.buffs_size,
			Position = {"LEFT", P_PROC_ICON_Anchor},
	...
	["DRUID"] = {
		{
			...
			-- Рывок тигры
			{spellID = 252216, unitID = "player", caster = "player", filter = "BUFF"},
			-- Изобилие
			{spellID = 207383, unitID = "player", caster = "player", filter = "BUFF"},
			-- Расцвет
			{spellID = 197721, unitID = "player", caster = "player", filter = "BUFF"},
			-- Свободный удар
	...
	["ALL"] = {
		{
			...
			Alpha = 1,
			IconSize = C.filger.buffs_size,
			Position = {"LEFT", SPECIAL_P_BUFF_ICON_Anchor},
			...
			-- Защитник Азерота
			{spellID = 280713, unitID = "player", caster = "all", filter = "BUFF"},
			-- Критовый ветерок
			{spellID = 280433, unitID = "player", caster = "all", filter = "BUFF"},
			-- Тайны глубин
			{spellID = 273842, unitID = "player", caster = "all", filter = "BUFF"},
			-- Тайны глубин 2
			--{spellID = 273843, unitID = "player", caster = "all", filter = "BUFF"},
			-- ТКолода карт
			--{spellID = 276187, unitID = "player", caster = "all", filter = "BUFF"},
			--{spellID = 276188, unitID = "player", caster = "all", filter = "BUFF"},
			--{spellID = 276189, unitID = "player", caster = "all", filter = "BUFF"},
			--{spellID = 276190, unitID = "player", caster = "all", filter = "BUFF"},
			--{spellID = 276191, unitID = "player", caster = "all", filter = "BUFF"},
			--{spellID = 276192, unitID = "player", caster = "all", filter = "BUFF"},
			--{spellID = 276193, unitID = "player", caster = "all", filter = "BUFF"},
			--{spellID = 276194, unitID = "player", caster = "all", filter = "BUFF"},
		},
		{
			Name = "PVE/PVP_DEBUFF",
			Direction = "UP",
			...
			Position = {"LEFT", PVE_PVP_DEBUFF_Anchor},
