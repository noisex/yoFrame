...
----------------------------------------------------------------------------------------
n.moveCreateAnchor("yoMoveArtifact", 	"Move Artifact", 7, 173, 5, -1, "TOPLEFT", "TOPRIGHT", n.infoTexts.LeftDataPanel)
...
logan:SetScript("OnEvent", function(self, event)
	...
	if not yo.Addons.ArtifactPowerbar or not player then return end
