			...
			if UnitExists( unit .. "target") then
				if yo.NamePlates.anonceCast and not UnitInRaid("player") then
					if UnitIsUnit("player", unit .. "target")
						--and ( yo.myRole == "HEALER" or yo.myRole == "DAMAGER" )
						then
							print( n.myColorStr .. f.name .. " on me!")
					end
				end
...
n.createCastBarNP = function( f)
	...
	f.Castbar:SetStatusBarTexture( n.texture)
	f.Castbar:SetStatusBarColor(1, 0.8, 0)
	tinsert( n.Addons.elements.statusBars, f.Castbar)
