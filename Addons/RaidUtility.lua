...
/cwm 8
	...
	CancelButton:SetScript("OnMouseUp", function(self)
		C_ChatInfo.SendAddonMessage("BigWigs", "P^Pull^0")
		local _,_,_,_,_,_,_,mapID = GetInstanceInfo()
		C_ChatInfo.SendAddonMessage("D4", ("PT\t%d\t%d"):format( 0,mapID or -1))
	...
	Pull5Button:SetScript("OnMouseUp", function(self)
		C_ChatInfo.SendAddonMessage("BigWigs", "P^Pull^5")
		local _,_,_,_,_,_,_,mapID = GetInstanceInfo()
		C_ChatInfo.SendAddonMessage("D4", ("PT\t%d\t%d"):format( 5,mapID or -1))
	...
	Pull10Button:SetScript("OnMouseUp", function(self)
		C_ChatInfo.SendAddonMessage("BigWigs", "P^Pull^105")
		local _,_,_,_,_,_,_,mapID = GetInstanceInfo()
		C_ChatInfo.SendAddonMessage("D4", ("PT\t%d\t%d"):format( 10,mapID or -1))
