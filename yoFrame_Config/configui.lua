			...
			whatsN = {
				...
				args = {
					...
					label01 = { order = 998, type = "description",
						...
						.."\n - [|cffffff00Рейдфреймы|r] ползунок для затемнения/осветления классовых цветов на фреймах"
						.."\n - [|cffffff00Рейдфреймы|r] Средняя кнопка мыши по игроку = массрес/баттрес/просторес ( лок - налаживает свой камень)"
						.."\n - [|cffffff00Неймплайты|r] показывать таунты от других игроков"
						.."\n - [|cffffff00Неймплайты|r] тестируем заготовку под \"плохие касты\""
						.."\n - [|cffffff00Чат|r] сохранение истории введеных команд"
						.."\n - [|cffffff00Чат|r] сохранение истории гильд/пати/рейд чата и остальных каналов"
						.."\n - [|cffffff00Задания|r] показывать ежедневные квесты, которые выдаются при входе в игру"
