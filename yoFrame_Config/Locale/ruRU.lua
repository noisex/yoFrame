...
L.moveWidget			= "Двигать верхне-центральный виджет ( Очко утробское)"
...
L.combatLog 		= "Убрать закладку 'Журнал' ( Combat Log)"
L.wisperMySound   	= "Изменить звук личныйх сообщений"
L.wisperDelay 		= "Пикать с задеркой"
L.wisperDelaySec	= "... в секунд"
L.myWisperSound     = " "
