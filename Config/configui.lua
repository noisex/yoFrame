		...
		args = {
			...
			NamePlates = {
				...
				args = {	
					...
					desc01 = {	order = 79, type = "description", name = "Цвета по типу агро:", width = "full",},

					c0 ={	order = 80, type = "color",	name = "0. Малое агро ( ДД, хил)", width = 1.5,
						get = function(info, r, g, b)  return strsplit( ",", yo[info[1]][info[#info]])	end,
						set = function(info, r, g, b) Setlers( info[1] .. "#" .. info[#info], strjoin(",", r, g, b)) end,},	
					c0t ={	order = 81, type = "color",	name = "0. Танк",	width = 0.5,
						get = function(info, r, g, b)  return strsplit( ",", yo[info[1]][info[#info]])	end,
						set = function(info, r, g, b) Setlers( info[1] .. "#" .. info[#info], strjoin(",", r, g, b)) end,},	
					
					c1 ={	order = 82, type = "color",	name = "1. Срыв агро ( моб еще на танке) > 100%",  width = "full",
						get = function(info, r, g, b)  return strsplit( ",", yo[info[1]][info[#info]])	end,
						set = function(info, r, g, b) Setlers( info[1] .. "#" .. info[#info], strjoin(",", r, g, b)) end,},	
					c2 ={	order = 84, type = "color",	name = "2. Потеря агро ( моб еще на тебе) < 100%",  width = "full",
						get = function(info, r, g, b)  return strsplit( ",", yo[info[1]][info[#info]])	end,
						set = function(info, r, g, b) Setlers( info[1] .. "#" .. info[#info], strjoin(",", r, g, b)) end,},	
					
					c3 ={	order = 86, type = "color",	name = "3. Танкинг ( ДД, хил)",width = 1.5,
						get = function(info, r, g, b)  return strsplit( ",", yo[info[1]][info[#info]])	end,
						set = function(info, r, g, b) Setlers( info[1] .. "#" .. info[#info], strjoin(",", r, g, b)) end,},	
					c3t ={	order = 87, type = "color",	name = "3. Танк",	width = 0.5,
						get = function(info, r, g, b)  return strsplit( ",", yo[info[1]][info[#info]])	end,
						set = function(info, r, g, b) Setlers( info[1] .. "#" .. info[#info], strjoin(",", r, g, b)) end,},	
					
					desc02 = {	order = 87, type = "description", name = "Дополнительные цвета:", width = "full",},

					myPet ={	order = 88, type = "color",	name = "Мой пет ( чужой пет из группы, если танк)",  width = "full",
						get = function(info, r, g, b)  return strsplit( ",", yo[info[1]][info[#info]])	end,
						set = function(info, r, g, b) Setlers( info[1] .. "#" .. info[#info], strjoin(",", r, g, b)) end,},	
					tankOT ={	order = 90, type = "color",	name = "Агро на другом танке ( если ты танк)",  width = "full",
						get = function(info, r, g, b)  return strsplit( ",", yo[info[1]][info[#info]])	end,
						set = function(info, r, g, b) Setlers( info[1] .. "#" .. info[#info], strjoin(",", r, g, b)) end,},	
					badGood ={	order = 92, type = "color",	name = "Моб с таргетом, в бою ( нулевое агро, не опасно)",  width = "full",
						get = function(info, r, g, b)  return strsplit( ",", yo[info[1]][info[#info]])	end,
						set = function(info, r, g, b) Setlers( info[1] .. "#" .. info[#info], strjoin(",", r, g, b)) end,},	
				},
			},	
			...
			fliger = {
				...
				args = {	
					...
					tDebuffSize		= {	order = 12,	type = "range", name = "Размер иконки",	min = 10, max = 70, step = 1, width = 0.75},
					pCDSize 		= {	order = 22,	type = "range", name = "Размер иконки",	min = 10, max = 70, step = 1, width = 0.75},
					pBuffSize 		= {	order = 32,	type = "range", name = "Размер иконки",	min = 10, max = 70, step = 1, width = 0.75},
					pDebuffSize		= {	order = 42,	type = "range", name = "Размер иконки",	min = 10, max = 70, step = 1, width = 0.75},
					pProcSize		= {	order = 52,	type = "range", name = "Размер иконки",	min = 10, max = 70, step = 1, width = 0.75},
