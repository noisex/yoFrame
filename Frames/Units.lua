...
------------------------------------------------------------------------------------------------------
	...
	self.Power.bgPower:SetTexture( texture)
	...
	if unit == "player" then
		...
		powerFlashBar:SetStatusBarTexture( texture)
...
------------------------------------------------------------------------------------------------------
	...
	if unit ~= "pet" or unit ~= "targettarget" or unit ~= "focus" or unit ~= "focustarget" then
		...
		self.Power.powerText:SetFont( font, fontsize -1, "OUTLINE")
		...
		self.rText:SetFont( yo.Media.fontpx, fontsize, "OUTLINE")
...
------------------------------------------------------------------------------------------------------
  ...
  --  	self.PvPIndicator.Badge = Badge
		...
		self.lfd:SetFont( fontsymbol, fontsize - 1)
